...
export default function TanStack({ className }: { className?: string }) {
  ...
  return (
    <motion.button
      className={cn(
        "relative flex items-center justify-center size-14 bg-white dark:bg-black rounded-full border border-border focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring cursor-pointer overflow-hidden",
        className
      )}
      whileTap={{ scale: 0.95 }}
        ...
        <g mask="url(#tanstack__c)">
          <motion.g
            variants={{
              ...
              visible: { y: 0, opacity: 1, transition: { duration: 0.6, ease: "backOut", delay: 0.2 } }
            }}
          >
        ...
        <g mask="url(#tanstack__c)">
          <g transform="translate(389 -32)">
            <motion.g
              ...
              style={{ originX: "168.5px", originY: "113.5px" }}
            >
